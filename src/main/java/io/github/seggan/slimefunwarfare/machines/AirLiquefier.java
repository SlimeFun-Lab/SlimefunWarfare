...
public class AirLiquefier extends AContainer implements RecipeDisplayItem {
    ...
    public AirLiquefier() {
        super(Categories.MACHINES, Items.AIR_LIQUEFIER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{
            new ItemStack(Material.PACKED_ICE), SlimefunItems.COOLING_UNIT.asOne(), new ItemStack(Material.PACKED_ICE),
            SlimefunItems.COOLING_UNIT.asOne(), SlimefunItems.FREEZER.asOne(), SlimefunItems.COOLING_UNIT.asOne(),
            new ItemStack(Material.PACKED_ICE), SlimefunItems.COOLING_UNIT.asOne(), new ItemStack(Material.PACKED_ICE)
        });
    }
